...
procedure TForm_hubungan.editbersih;
begin
c1.text:= '';
c2.text:= '';
Edit1.Clear;
...
procedure TForm_hubungan.editenable;
begin
c1.Enabled:= True;
c2.Enabled:= True;
edit1.Enabled:= True;
...
procedure TForm_hubungan.posisiawal;
begin
editbersih;
...
procedure TForm_hubungan.b1Click(Sender: TObject);
begin
editbersih;
...
procedure TForm_hubungan.b2Click(Sender: TObject);
begin
...
procedure TForm_hubungan.b3Click(Sender: TObject);
begin
if (c1.Text= '')or (c2.Text= '') or (Edit1.Text= '')or (Edit2.Text ='') or (Edit3.Text ='')then
begin
...
procedure TForm_hubungan.b4Click(Sender: TObject);
begin
...
procedure TForm_hubungan.b5Click(Sender: TObject);
begin
posisiawal;
end;

procedure TForm_hubungan.b6Click(Sender: TObject);
begin
frxhub.ShowReport();
end;

procedure TForm_hubungan.FormShow(Sender: TObject);
begin
posisiawal;
end;

procedure TForm_hubungan.dg1CellClick(Column: TColumn);
begin
editenable;
b1.Enabled:= true;
b2.Enabled:= False;
...
procedure TForm_hubungan.FormCreate(Sender: TObject);
begin
zqry2.First;
